...
latex_documents = [
    (master_doc, 'jdna.tex', 'jdna Documentation',
     'Justin Vrana', 'manual'),
]
...
man_pages = [
    (master_doc, 'jdna', 'jdna Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jdna', 'A python DNA sequence editor',
     author, 'jdna', 'One line description of project.',
     'Miscellaneous'),
]
