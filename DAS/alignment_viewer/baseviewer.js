...
(function() {
  ...
  d3.json('data.json', function(data) {
    ...
    svg.selectAll('rects').data(data.contigs).enter().append('rect').attr('x', function(d) {
      ...
      return tooltip.html('<b>Subject: </b>' + d.subject_acc + '<br>' + '<b>QRange:\t</b> ' + d.q_start + '-' + d.q_end + '<br>' + '<b>Type:\t</b>' + d.contig_type + '<br>' + '<b>Id:\t</b>' + d.contig_id + '<br>' + '<b>SRange:\t</b>' + d.s_start + '-' + d.q_end).style("visibility", "visible");
